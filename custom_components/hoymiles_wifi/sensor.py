...
HOYMILES_SENSORS = [
    ...
    {
        "name": "Port 3 Voltage",
        "attribute_name": "pv_data[2].voltage",
        "conversion_factor": 0.1,
        "unit_of_measurement": ELECTRIC_POTENTIAL_VOLT,
        "device_class": SensorDeviceClass.VOLTAGE,
        "state_class": STATE_CLASS_MEASUREMENT,
    ...
    {
        "name": "Port 3 Current",
        "attribute_name": "pv_data[2].current",
        "conversion_factor": 0.01,
        "unit_of_measurement": ELECTRIC_CURRENT_AMPERE,
        "device_class": SensorDeviceClass.CURRENT,
        "state_class": STATE_CLASS_MEASUREMENT,
    ...
    {
        "name": "Port 3 Power",
        "attribute_name": "pv_data[2].power",
        "conversion_factor": 0.1,
        "unit_of_measurement": POWER_WATT,
        "device_class": SensorDeviceClass.POWER,
        "state_class": STATE_CLASS_MEASUREMENT,
    ...
    {
        "name": "Port 3 Total Energy",
        "attribute_name": "pv_data[2].energy_total",
        "conversion_factor": None,
        "unit_of_measurement": ENERGY_WATT_HOUR,
        "device_class": SensorDeviceClass.ENERGY,
        "state_class": STATE_CLASS_TOTAL_INCREASING,
    ...
    {
        "name": "Port 3 Daily Energy",
        "attribute_name": "pv_data[2].energy_daily",
        "conversion_factor": None,
        "unit_of_measurement": ENERGY_WATT_HOUR,
        "device_class": SensorDeviceClass.ENERGY,
        "state_class": STATE_CLASS_TOTAL_INCREASING,
    ...
    {
        "name": "Port 4 Voltage",
        "attribute_name": "pv_data[3].voltage",
        "conversion_factor": 0.1,
        "unit_of_measurement": ELECTRIC_POTENTIAL_VOLT,
        "device_class": SensorDeviceClass.VOLTAGE,
        "state_class": STATE_CLASS_MEASUREMENT,
    ...
    {
        "name": "Port 4 Current",
        "attribute_name": "pv_data[3].current",
        "conversion_factor": 0.01,
        "unit_of_measurement": ELECTRIC_CURRENT_AMPERE,
        "device_class": SensorDeviceClass.CURRENT,
        "state_class": STATE_CLASS_MEASUREMENT,
    ...
    {
        "name": "Port 4 Power",
        "attribute_name": "pv_data[3].power",
        "conversion_factor": 0.1,
        "unit_of_measurement": POWER_WATT,
        "device_class": SensorDeviceClass.POWER,
        "state_class": STATE_CLASS_MEASUREMENT,
    ...
    {
        "name": "Port 4 Total Energy",
        "attribute_name": "pv_data[3].energy_total",
        "conversion_factor": None,
        "unit_of_measurement": ENERGY_WATT_HOUR,
        "device_class": SensorDeviceClass.ENERGY,
        "state_class": STATE_CLASS_TOTAL_INCREASING,
    ...
    {
        "name": "Port 4 Daily Energy",
        "attribute_name": "pv_data[3].energy_daily",
        "conversion_factor": None,
        "unit_of_measurement": ENERGY_WATT_HOUR,
        "device_class": SensorDeviceClass.ENERGY,
        "state_class": STATE_CLASS_TOTAL_INCREASING,
